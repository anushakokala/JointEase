    ...
    <div className="flex flex-col">
      <div className="flex flex-col self-stretch min-h-screen">
        ...
        <div className="flex justify-center mb-10 space-x-10">
          ...
          <div className="flex flex-col items-center">
            <button className="w-20 h-20 ml-3 bg-blue rounded-full flex items-center justify-center"
              onClick={goToSettings}>
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="45" viewBox="0 0 119 119" fill="none">
            ...
            <div className="text-lg text-center mt-4 ml-3 ">Settings</div>
          </div>
        </div>
        <div className="flex items-start mb-6 mx-10 space-x-7">
