      ...
      <div className="flex flex-col self-stretch min-h-screen">
        <div>
          <input
            ...
            placeholder="Search"
            className="w-[1000px] bg-[#FAFAFAED] pt-2 pb-2 pl-2 pr-2 mt-10 mb-20 ml-10 mr-10 rounded-xl border-[0.3px] border-solid border-[#00000080]"
          />
        </div>
        ...
        <div className="flex justify-center mb-10 space-x-10">
          <div className="flex flex-col items-center">
            <button className="w-20 h-20 bg-blue rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="45" height="50" viewBox="0 0 31 31" fill="none">
                <g clip-path="url(#clip0_6_57)">
                  <path d="M7.75 5.16667H6.45833C5.77319 5.16667 5.11611 5.43884 4.63164 5.92331C4.14717 6.40778 3.875 7.06486 3.875 7.75V12.2708C3.875 14.155 4.62347 15.9619 5.95576 17.2942C7.28805 18.6265 9.09502 19.375 10.9792 19.375C12.8633 19.375 14.6703 18.6265 16.0026 17.2942C17.3349 15.9619 18.0833 14.155 18.0833 12.2708V7.75C18.0833 7.06486 17.8112 6.40778 17.3267 5.92331C16.8422 5.43884 16.1851 5.16667 15.5 5.16667H14.2083" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M10.3333 19.375C10.3333 20.3927 10.5338 21.4005 10.9232 22.3408C11.3127 23.2811 11.8836 24.1354 12.6032 24.8551C13.3229 25.5747 14.1772 26.1456 15.1175 26.5351C16.0578 26.9245 17.0656 27.125 18.0833 27.125C19.1011 27.125 20.1088 26.9245 21.0491 26.5351C21.9894 26.1456 22.8437 25.5747 23.5634 24.8551C24.283 24.1354 24.8539 23.2811 25.2434 22.3408C25.6329 21.4005 25.8333 20.3927 25.8333 19.375V15.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M14.2083 3.875V6.45833" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M7.75 3.875V6.45833" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M25.8333 15.5C27.2601 15.5 28.4167 14.3434 28.4167 12.9167C28.4167 11.4899 27.2601 10.3333 25.8333 10.3333C24.4066 10.3333 23.25 11.4899 23.25 12.9167C23.25 14.3434 24.4066 15.5 25.8333 15.5Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
              </svg>
            </button>
          ...
          <div className="flex flex-col items-center">
            <button className="w-20 h-20 bg-blue rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="45" height="32" viewBox="0 0 16 16" fill="none">
                <path d="M3 4H1C0.447715 4 0 4.44772 0 5V15C0 15.5523 0.447715 16 1 16H3C3.55228 16 4 15.5523 4 15V5C4 4.44772 3.55228 4 3 4Z" fill="white" />
                <path d="M9 6H7C6.44772 6 6 6.44772 6 7V15C6 15.5523 6.44772 16 7 16H9C9.55228 16 10 15.5523 10 15V7C10 6.44772 9.55228 6 9 6Z" fill="white" />
                <path d="M15 0H13C12.4477 0 12 0.447715 12 1V15C12 15.5523 12.4477 16 13 16H15C15.5523 16 16 15.5523 16 15V1C16 0.447715 15.5523 0 15 0Z" fill="white" />
              </svg>
            </button>
        ...
        <div className="flex justify-between items-center mb-20 -ml-56 mr-[30px]">
          <div className="flex-1 text-md font-bold">Recommendation Articles</div>
          <button className="flex-1 text-blue text-sm text-right mr-4">See all</button>
        </div>
